...
void Setup (LBM::Domain & dom, void * UD)
{
    ...
    double rho0min = 0.999*((rho - dat.rho)*dat.Dp(0) + dat.rho);
    double rho1min = 0.001*((rho - dat.rho)*dat.Dp(0) + dat.rho);
    double rho0max = 0.001*((dat.rho - rho)*dat.Dp(0) + dat.rho);
    double rho1max = 0.999*((dat.rho - rho)*dat.Dp(0) + dat.rho);
